...
görseli ekleyerek 1 kapsam maddesi (K-42), 2 karar (A-71, A-72) ve 1 kural (Y-78) ekledi. Yığın,
...
| | |
|---|---|
| Karar | 72 (36 v1.0 + 7 v2.0 + 4 v3.0 + 7 v4.0 + 5 v5.0 + 9 v6.0 + 1 v6.3 + 1 v6.4 + 2 v6.5) |
| Yasak kural | 78 (52 v1.0 + 6 v2.0 + 2 v3.0 + 4 v4.0 + 4 v5.0 + 7 v6.0 + 1 v6.3 + 1 v6.4 + 1 v6.5) |
| V1 dışı madde | 13 (K-13 v4.0'da **ikiye bölündü** — bkz. §3) |
| Uygulama fazı | 38 (7 v1.0 + 7 v2.0 + 4 v3.0 + 5 v4.0 + 6 v5.0 + 6 v6.0 + 1 v6.3 + 1 v6.4 + 1 v6.5) |
...
2. [Açıkça yasak (Y-01 … Y-78)](#2-açıkça-yasak)
3. [V1 kapsamı (K-01 … K-42)](#3-v1-kapsamı)
4. [Teknoloji ve domain](#4-teknoloji-ve-domain)
5. [Uygulama sırası](#5-uygulama-sırası)
6. [Karar kaydı (A-01 … A-72)](#6-karar-kaydı)
