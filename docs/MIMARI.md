...
(K-41), 1 karar (A-70) ve 1 kural (Y-77) ekledi. Yığın, kapsam ve kurallar sabit; bundan sonrası uygulama.
...
| | |
|---|---|
| Karar | 70 (36 v1.0 + 7 v2.0 + 4 v3.0 + 7 v4.0 + 5 v5.0 + 9 v6.0 + 1 v6.3 + 1 v6.4) |
| Yasak kural | 77 (52 v1.0 + 6 v2.0 + 2 v3.0 + 4 v4.0 + 4 v5.0 + 7 v6.0 + 1 v6.3 + 1 v6.4) |
| V1 dışı madde | 13 (K-13 v4.0'da **ikiye bölündü** — bkz. §3) |
| Uygulama fazı | 37 (7 v1.0 + 7 v2.0 + 4 v3.0 + 5 v4.0 + 6 v5.0 + 6 v6.0 + 1 v6.3 + 1 v6.4) |
...
2. [Açıkça yasak (Y-01 … Y-77)](#2-açıkça-yasak)
3. [V1 kapsamı (K-01 … K-41)](#3-v1-kapsamı)
4. [Teknoloji ve domain](#4-teknoloji-ve-domain)
5. [Uygulama sırası](#5-uygulama-sırası)
6. [Karar kaydı (A-01 … A-70)](#6-karar-kaydı)
